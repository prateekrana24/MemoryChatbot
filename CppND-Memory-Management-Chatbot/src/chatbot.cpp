...
//// STUDENT CODE
////
ChatBot::ChatBot(const ChatBot &origin) //copy constructor
{
...
ChatBot &ChatBot::operator=(const ChatBot &origin) //copy assignment operator
{
  std::cout << "This is the copy assignment operator" << std::endl;
